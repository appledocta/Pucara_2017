Public Class FrmUsuario
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If Me.ValidateChildren = True And txtNombre.Text <> "" And txtContrasena.Text <> "" And cmbCategoria.Text <> "" Then

            Try
                Dim dts As New UsuariosLogica
                Dim func As New UsuariosDatos
